    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewsReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewsReplies_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewsReplies_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewsReplies_ReviewId",
                table: "ReviewsReplies",
                column: "ReviewId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsReplies_UserId",
                table: "ReviewsReplies",
                column: "UserId");
